...
new_reward = self.custom_reward_fn(observation, action, original_reward, terminated, truncated, info)
...
code_formatting_tip = """The output of the reward function should consist of two items:
(1) the total reward,
